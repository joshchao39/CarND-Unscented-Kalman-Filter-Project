...
int run_from_file() {
  ...
  cout << "Laser Predicted Measurement above NIS 5% threshold = " << (double) ukf.NIS_laser_cnt / N  * 100 << "%" << endl;
  cout << "Radar Predicted Measurement above NIS 5% threshold = " << (double) ukf.NIS_radar_cnt / N  * 100 << "%" << endl;
